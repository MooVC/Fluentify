namespace Fluentify.Console.Record.NestedInRefRecordStructTests;
...
public sealed class WhenWithAgeIsCalled
{
    ...
    public void GivenNullSubjectThenArgumentNullExceptionIsThrown()
    {
        ...
        // Act
        Func<NestedInRefRecordStruct.Simple> act = () => subject!.WithAge(1);
    ...
    public void GivenAnAgeThenTheValueIsApplied(int age)
    {
        ...
        // Act
        NestedInRefRecordStruct.Simple actual = original.WithAge(age);
