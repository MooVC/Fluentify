...
public sealed partial class WhenGetExtensionsIsCalled
{
    ...
    [InlineData("throw new NotImplementedException();")]
    [InlineData("return new();")]
    public void GivenBclPropertyThenDoesNotGenerateDelegateExtension(string scalar)
    {
        // Arrange
        string expected = $$"""
            using System;
    ...
    [InlineData("throw new NotImplementedException();")]
    [InlineData("return new();")]
    public void GivenValueTypePropertyThenDoesNotGenerateDelegateExtension(string scalar)
    {
        // Arrange
        string expected = $$"""
            using System;
